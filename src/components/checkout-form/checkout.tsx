...
const handleOrder= async () =>{
  ...
  <p><strong>Ship Date:</strong> {new Date(shipment?.shipDate).toLocaleString()}</p>
  <p><strong>Carrier ID:</strong> {shipment?.carrierId}</p>
  <p><strong>Carrier Code:</strong> {shipment?.carrierCode}</p>
  <p><strong>Tracking Number:</strong> {shipment?.trackingNumber}</p>
  <p><strong>Tracking Status:</strong> {shipment?.trackingStatus}</p>
  <p><strong>Label ID:</strong> {shipment?.labelId}</p>
  </div>
