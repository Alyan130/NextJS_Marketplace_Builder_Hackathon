          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className='flex items-center rounded-full justify-end sm:space-x-8 space-x-6 ml-32 sm:hidden'>
              <div className="flex flex-col items-center justify-end gap-0.5 cursor-pointer">
                ...
                <Link href={"/wishlist"}> <svg xmlns="http://www.w3.org/2000/svg" className="cursor-pointer fill-[#333] inline w-6 h-6"
                    viewBox="0 0 64 64">
                    <path
              ...
              <div className="flex flex-col items-center justify-center gap-0.5 cursor-pointer">
                <div className="relative">
                <Link href={"/cart"}> <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" className="cursor-pointer fill-[#333] inline"
                    viewBox="0 0 512 512">
                    <path
            ...
            <Sheet>
              ...
              <SheetContent className="flex flex-col items-center py-20 px-6 bg-white">
                <ul className="mb-6 text-center">
                  ...
                  <DropdownMenu>
  <DropdownMenuTrigger className="text-[#636270] text-[18px]  font-medium  hover:text-btncolor mb-2">Products</DropdownMenuTrigger>
  <DropdownMenuContent>
    <DropdownMenuSeparator />
